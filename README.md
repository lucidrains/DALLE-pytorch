...
You can also skip the training of the VAE altogether, using the pretrained VAE model released by OpenAI!

Just import and instantiate `OpenAIDiscreteVAE`. The wrapper class should take care of downloading and caching the model for you automatically.
